...
TARGET = CANDataTransfer
TEMPLATE = app

SOURCES += main.cpp         application.cpp     keypad.cpp \
    can_handler3.cpp \
    canworkerthread.cpp \
    canwrapper.cpp

HEADERS += application.h        keypad.h \
    can_handler3.h \
    canworkerthread.h \
    canwrapper.h

FORMS += application.ui     keypad.ui
...
target.path = /opt/CANDataTransfer/
INSTALLS += target
}
